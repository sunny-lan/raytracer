...
objects.Add(new Sphere(new(0, -100, -1), 100, new Lambertian(new Vector3(0.2, 0.2, 0.2))));
...
objects.AddRange(MeshLoader.Load("Klee/Body.obj", new Lambertian(new ImageTexture("Klee/Avatar_Loli_Catalyst_Klee_Tex_Body_Diffuse.png"))));
...
Vector3 RayColor(Ray r, int depth)
{
    ...
    Vector3 sunDir = new(0.2, -1, 0), sunCol =new(5,5,5), skyCol = new(0.1,0.05,0.5);
